...
>>>>>>> 39275fa1400e701a9a4ef66af52f472f781c0a59
      case 'email':
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-5 space-y-8 order-2 lg:order-1">
            ...
            <a
              ...
              className="flex items-center justify-between p-5 rounded-2xl bg-white border border-slate-200 shadow-sm hover:border-teal-400 hover:shadow-md hover:bg-teal-50/10 transition-all duration-300 group"
            >
              <div>
                <h3 className="text-lg font-bold text-slate-900 group-hover:text-teal-700 transition-colors">Download Resume</h3>
                <p className="text-sm text-slate-500 mt-1">Get a copy of my CV in PDF format.</p>
              </div>
              <div className="w-12 h-12 rounded-full bg-slate-50 text-slate-600 flex items-center justify-center group-hover:bg-teal-100 group-hover:text-teal-700 transition-colors">
                <Icons.Download />
              </div>
            </a>
