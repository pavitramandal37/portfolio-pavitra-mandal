...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'Conversational AI chatbot that answers API documentation queries using RAG-based semantic search. Runs locally on Ollama with Django, PostgreSQL + pgvector, and Docker.',
  ...
  // ============================================
  {
    ...
    description: 'Developed & deployed an AI-driven demand forecasting platform at Sony. System is now in production — currently leading performance optimization and operational delivery across 280+ product lines globally.',
    longDescription: 'Led the development of Sony\'s enterprise AI demand forecasting platform on Azure Databricks. The system is now fully deployed and operational across 280+ product lines spanning global markets (Japan, North America, Southeast Asia). Currently in the performance optimization and operations delivery phase — tuning model accuracy, monitoring pipeline health, and driving measurable forecasting outcomes for supply chain and inventory planning.',
  ...
  {
    id: 'sale-data-agent',
    title: 'Sales Data Agent - Enterprise AI with Snowflake Intelligence',
    slug: 'sale-data-agent',
    description: 'Currently leading development of an enterprise conversational AI agent that enables business users to query Snowflake sales data in plain English — no SQL required. Built on Snowflake Cortex Intelligence with RAG, Text-to-SQL, and AI Observability.',
    ...
    techStack: [
      ...
      'Snowflake Cortex Analyst (Text-to-SQL)',
      'Snowflake Cortex Search (RAG)',
      'TruLens (AI Observability)',
