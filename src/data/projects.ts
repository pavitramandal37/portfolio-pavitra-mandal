...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'Enterprise AI agent enabling business users to query sales data using natural language, eliminating dependency on complex SQL queries through Snowflake Cortex Analyst and Intelligence.',
  ...
  // ============================================
  {
    ...
    thumbnail: '/images/projects/tableau-sales-analysis/thumbnail.png',
    links: [
